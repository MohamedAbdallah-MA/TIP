...
<div
    class="task-card bg-white dark:bg-gray-700 rounded-lg shadow-sm border-2 {{ $task->priority->borderColorClass() }} dark:border-opacity-75 p-4 cursor-pointer hover:shadow-md transition-shadow duration-200"
...
>
    ...
    <div class="flex items-center justify-between mb-2">
        <div class="flex items-center gap-2">
            ...
            <span class="priority-badge {{ $task->priority->badgeClass() }}">
                {{ $task->priority->label() }}
            </span>
        </div>
